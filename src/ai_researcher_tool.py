# Code adapted from: https://github.com/NoviScl/AI-Researcher/blob/main/ai_researcher/src/utils.py
import json
import random 
...
def calc_price(model, usage):
    ...
    if model == "gpt-4o":
        return (0.0025 * usage.prompt_tokens + 0.010 * usage.completion_tokens) / 1000.0
    if model == "gpt-4o-mini":
        return (0.00015 * usage.prompt_tokens + 0.0006 * usage.completion_tokens) / 1000.0
    if model == "deepseek-chat":
        return (0.000014 * usage.prompt_tokens + 0.00028 * usage.completion_tokens) / 1000.0
...
def shuffle_dict_and_convert_to_string(input_dict, n=-1):
